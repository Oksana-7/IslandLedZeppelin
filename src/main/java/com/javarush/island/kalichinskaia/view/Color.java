...
public class Color {
    ...
    public static final String BLACK = "\u001B[30m"; // todo remove ???
    public static final String RED = "\u001B[31m";
    public static final String GREEN = "\u001B[32m";
    public static final String YELLOW = "\u001B[33m";
    public static final String BLUE = "\u001B[34m";
    public static final String PURPLE = "\u001B[35m";
    public static final String CYAN = "\u001B[36m";  // todo remove ???
    public static final String WHITE = "\u001B[37m"; // todo remove ???
    ...
    public static final String FILL_CYAN = "\u001B[46m"; // todo remove ???
